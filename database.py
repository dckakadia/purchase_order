...
def init_db():
    ...
    try:
        ...
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_cinv_customer_id ON customer_invoices(customer_id)")
        cursor.execute("CREATE INDEX IF NOT EXISTS idx_cinvi_invoice_id ON customer_invoice_items(invoice_id)")
